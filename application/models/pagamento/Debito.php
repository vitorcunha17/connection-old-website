<?php
	...
	class Debito extends Pagamento {				
		...
		public function pagarDebito($pag_valor, $pag_hash, array $dadosComprador) {
			...
			"senderName"		=> 	$dadosComprador['de_nome'],
			"senderCPF"			=>	$dadosComprador['de_cpf'],
			"senderAreaCode"	=>	$dadosComprador['de_area'],
			"senderPhone"		=>	$dadosComprador['de_telefone'],
			"senderEmail"		=>	"teste@sandbox.pagseguro.com.br", //$this->session->userdata('email_empresa'),
			"senderHash" 		=>  $pag_hash,
			"shippingAddressStreet"		=>	$dadosComprador['de_rua'],
			"shippingAddressNumber"		=> $dadosComprador['de_numero_residencia'],
			"shippingAddressComplement"	=> "", //opcional
			"shippingAddressDistrict"	=> $dadosComprador['de_bairro'],
			"shippingAddressPostalCode"	=> $dadosComprador['de_cep'],
			"shippingAddressCity"		=> $dadosComprador['de_cidade'],
			"shippingAddressState"		=> $dadosComprador['de_estado'],
			"shippingAddressCountry"	=> $dadosComprador['de_pais'],
