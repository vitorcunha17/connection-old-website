      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li> <a>Candidatos na 3ª fase da Triagem!</a></li>
          ...
          <div class="col-md-12">
                <div class="title-area">
                  ...
                  <?php if (!empty($_GET['sala'])): ?> 
                                        <a style="color: crimson; margin-left: -33%" href="<?= base_url('conference/watch/reuniao'); ?>">Encerrar <i style="margin-left: 10px" class="fas fa-video-slash"></i></a>
                                                  <?php else: ?>
          ...
          <div class="latest-news-content">
            <div class="row">
                  <div class="sidebar-widget">
                    <h4 class="widget-title">Candidatos Aprovados</h4>
                        ...
                        <a data-toggle="collapse" data-parent="#accordion" href="#<?= $candidatosSelecionadosValue->id_candidato ?>" aria-expanded="false" class="collapsed">
                            <span class="fa fa-user"></span> <?= $candidatosSelecionadosValue->nome; ?> -  
                            <?php  $j = 1; ?>
                            <?php while($j <= sizeof($result['carga'])  ): ?>
                                <?php if(!empty($result['carga'][$j]['reuniao'][0]->id_candidato)): ?>
                                    <?php if($candidatosSelecionadosValue->id_candidato == $result['carga'][$j]['reuniao'][0]->id_candidato):  ?>     
                                         <li>
                                            
                                                 <?php if (!empty($_GET['sala'])): ?> 
                                                 <?php if ($_GET['sala'] == $candidatosSelecionadosValue->video_nome ): ?> 
                                                    <H6 style="color: #4caf50" >Vídeo Coferencia ATIVA </H6>
                                                    ...
                                                    <input  type="hidden" style="margin-left: 60%" class="sala" name="" value="<?php  $sala = $_GET['sala'] ?? "<?= $candidatosSelecionadosValue->id_candidato ?"; echo $sala;  ?>">         
                                                   <?php else: ?>
                                                   <a href="<?= base_url('conference/watch/reuniao'); ?>?sala=<?= $candidatosSelecionadosValue->video_nome; ?> ">
                                                   <H6 style="color: darkmagenta" > Inativa </H6>
                       ...
                       <div id="<?= $candidatosSelecionadosValue->id_candidato ?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                              ...
                              <p style="width: 50%"><?= strtolower($candidatosSelecionadosValue->quemsou); ?></p><br>
                                  <?php if((strtolower($candidatosSelecionadosValue->situacao_curso)) == "concluido"): ?> 
                                  <p><a>Formado</a> em <?= strtolower($candidatosSelecionadosValue->nome_curso); ?></p>
                                  <?php else: ?> 
                                      <p><a>Estudante</a> de <?= strtolower($candidatosSelecionadosValue->nome_curso); ?></p>
                                  <?php endif; ?>
                                  <div class="sidebar-widget">
                                                                  ...
                                                                  <?php if(($candidatosSelecionadosValue->email == $result['carga'][$j]['cursos'][0]->email_candidato)):  ?>
                                                                          <?php $tam = count($result['carga'][$j]['cursos'])- 1; ?>
                                                                                  <?php while($tam >= 0): ?> 
                                                                                      ...
                                                                                      <span>Período: <?= $result['carga'][$j]['cursos'][$tam]->dataReferencia ?></span></a>
                                                                                  </div>
                                                                          <?php $tam--; ?>       
                                                                      <?php endwhile; ?>
                                                                  <?php  endif; ?>
                                                          ...
                                                          <?php if(!empty($result['carga'][$j]['experiencia'][0]->email_candidato)): ?>
                                                                  <?php if(($candidatosSelecionadosValue->email == $result['carga'][$j]['experiencia'][0]->email_candidato)):  ?>
                                                                          <?php $tam = count($result['carga'][$j]['experiencia'])- 1; ?>
                                                                              <?php while($tam >= 0): ?> <br> <br>
                                                                                    <h3> * <?= $result['carga'][$j]['experiencia'][$tam]->titulo ?></h3>
                                                                                      <div class="blog-navigation-prev" style="background-color: azure"><a>
                                                                                        <h5><?= $result['carga'][$j]['experiencia'][$tam]->empresa ?></h5>
                                                                                          ...
                                                                                          <br><span>Local: <?= $result['carga'][$j]['experiencia'][$tam]->cidadeEstado ?></span></a><br>
                                                                                      </div> 
                                                                          <?php $tam--; ?>       
                                                                      <?php endwhile; ?>
                                                                <?php  endif; ?>
            ...
            <?php if (empty($_GET['sala'])): ?> 
             ...
             <img src="https://png.pngtree.com/element_origin_min_pic/16/09/05/1957cd5314e8040.jpg">
             </div>
               <?php else: ?>
               <div id="localVideo"  style=”float:left;margin-top:2px;margin-bottom:10px;”></div>
               <div id="remoteVideo" style=”float:right;margin-top:70px;margin-bottom:10px;”></div>
                <?php endif; ?>
         </div>
      </div>
  </section>
...
connection.onstream = function(event) {
    ...
    if(event.type === 'local') {
        video.style = "position: relative; margin-left: -12%; margin-top: 50px; height: 40%; width: 35%; border-radius: 35px; ";
    ...
    if(event.type === 'remote') {
      ...
      video.style = "position: relative; margin-left: 24%; margin-top: -500px; height: 40%; width: 35%; border-radius: 35px;";
