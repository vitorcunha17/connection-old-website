...
#floating-panel {
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li> <a>Candidatos na 1ª fase da Triagem!</a></li>
  ...
  <script>
$('.mudatitulo').on('click', function(){

  $('h2.sadrak').text('R$ 20,00');
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title sadrak" id="titulo">1ª Fase do processo de triagem</h2>
            <span class="line"></span>
            <p>Análise do Vídeo-Curriculum com informaçoes complementares do Curriculum fornecido pelos candidatos</p>
          </div>
        </div>
              ...
              <!-- Inicio Card Candidato Selecionado -->
                  ...
                  <div class="col-md-4">
                        <article class="blog-news-single">
                          ...
                          <iframe src="https://player.vimeo.com/video/<?= $candidatosSelecionadosValue->video_nome ?>" width="320" height="240" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>   
                          <?php endif; ?> 
                              </div>
                                  <div class="blog-news-title">
                                    <h2><a  href=""><?= $candidatosSelecionadosValue->nome; ?> </a></h2>
                                    <p class="blog-author">
                                    <?php if((strtolower($candidatosSelecionadosValue->situacao_curso)) == "concluido"): ?> 
                                      <p>
                                        <a>Formado</a> em <?= strtolower($candidatosSelecionadosValue->nome_curso); ?>
                                      </p>
                                    <?php else: ?> 
                                     <p>
                                        <a>Estudante</a> de <?= strtolower($candidatosSelecionadosValue->nome_curso); ?>
                                      </p>
                                    <?php endif; ?>
                              ...
                              <div class="blog-news-details">
                                <?php if(empty($candidatosSelecionadosValue->quemsou)): ?>
                                <p>O Candidato Nao forneceu essa informaçao :( <br> 
                                <i style="margin-left: 30%" class="far fa-frown fa-7x"></i>
                                <br>
                              </p>
                               <?php else: ?>
                                    ...
                                    <div class="panel-heading">
                                      <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#<?= $candidatosSelecionadosValue->id_candidato ?>" aria-expanded="false" class="collapsed">
                                          Ver Curriculum Completo  <span style="margin-left: 20%" class="fa fa-arrow-circle-down"></span>
                                        </a>
                                      </h4>
                                      <br>
                                      <form method="post" " >
                                 <button data-identificador="<?= $candidatosSelecionadosValue->id_candidato; ?>" class="botaoCarrinho botao purchase-btn col-md-12">Selecionar</button>
                                 </form>
                                    </div>
               ...
               <?php endforeach; ?>
            <!-- Fim Card Candidato Selecionado -->
        ...
        <div class="text-left container">
                        <a type="submit"  href="" id="produtos" onClick="mudarCor()" class="purchase-btn col-md-offset-3 mudatitulo">Avançar Para 2ª Fase de Triagem</a>
                        <br><br>
                    </div>     
...
var carrinhoTotal = 0;
        ...
        $(document).ready(function() {
          $valorInicial = "<?= base_url('empresa/login/fasetwo'); ?>";
