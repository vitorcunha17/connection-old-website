...
<html id="home">
    <head>
        ...
        <meta property="og:url" content="http://[::1]/Sistema_v4/"/>
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/img'); ?>">
    ...
    <body>
        ...
        <div class="contato-topo">
            <div class="conteudo-site">
                <div class="contact">
                    <a class="link-contato email" href="mailto:contato@all-connection.com"><img src="../assets/img/mail.png"> contato@all-connection.com</a>
                    <a class="link-contato fone" href="tel:554100000000"><img src="../assets/img/fone.png">(41) 9 0000-0000</a>
                </div>
            ...
            <div class="section1">
                ...
                <div class="cont1 img-cont">
                    <div class="limite-img">
                        <img class="img-sobre" src="../../../../assets/img/img.jpg" alt="" title="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="projetos" class="padding-conteudo">
            <div class="conteudo-site">
                ...
                <div class="coluna-opcao">
                    <img class="img-hover" src="../../../../assets/img/1.jpg" alt="" />
                ...
                <div class="coluna-opcao">
                    <img class="img-hover" src="../../../../assets/img/2.jpg" alt="" />
                    <div class="info-hover">
                        <div class="centro-conteudo">
                            <h3>Título 2</h3>
                            <p>
        ...
        <section id="sobre" class="conteudo-site padding-conteudo">
            ...
            <div class="conteudo-site">
                <div class="conteudo-colunas left">
                    <img class="img-icones-sobre" src="../../../../assets/img/icon1.png" alt="" />
                    <h3>Título 1</h3>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet.
                    </p>
                ...
                <div class="conteudo-colunas bottom">
                    <img class="img-icones-sobre" src="../../../../assets/img/icon2.png" alt="" />
                    <h3>Título 2</h3>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet.
                    </p>
                ...
                <div class="conteudo-colunas right">
                    <img class="img-icones-sobre" src="../../../../assets/img/icon3.png" alt="" />
                    <h3>Título 3</h3>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet.
                    </p>
