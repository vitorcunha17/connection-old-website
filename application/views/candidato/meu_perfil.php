...
<script src="<?php echo base_url('assets/js/crud/jquery.min.js')?>"></script>
                    ...
                    <div class="blog-news-title">
                      <h2><a style="  " href="" class="typewrite" data-period="1000" data-type='[ "Forneça informaçoes para seu curriculum ficar completo :) ", "As Empresas querem saber mais sobre voce", "Clique em editar perfil para prencher informaçoes.", "Você com a Connection Rumo ao Sucesso! :)" ]'>
