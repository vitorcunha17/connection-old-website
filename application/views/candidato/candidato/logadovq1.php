                            ...
                            <div class="compact-sidebar light-sidebar has-shadow">
                                ...
                                <nav class="side-navbar box-scroll sidebar-scroll">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-receipt"></i><span>Curriculum</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-comments"></i><span>Menssagens</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-user"></i><span>Colegas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-world"></i><span>Grupos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-calendar"></i><span>Eventos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-palette"></i><span>Projetos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-shopping-cart"></i><span>Cursos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-apple"></i><span>Startups</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="ti ti-stats-up"></i><span>Estatisticas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="la la-angle-left"></i><span>voltar</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <!-- End Main Navigation -->
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="widget has-shadow">
                                                            ...
                                                            <div class="widget-header d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex flex-column mr-auto">
                                                                    <div class="title">
                                                                        <span class="username"><?= $dados[0]->nome; ?></span> Adicionou algo ao seu portfólio                                            </div>
                                                            ...
                                                            <div class="widget-body">
                                                                <div class="content-img">
                                                                    <a href="javascript:void(0);">
                                                                        <img src="../../assets2/img/background/01.jpg" class="img-fluid rounded" alt="...">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!-- End Widget Body -->
                                                            ...
                                                            <div class="comments">
                                                                <div class="comments-header d-flex align-items-center">
                                                                    <div class="user-image">
                                                                        <img class="rounded-circle" src="https://images-na.ssl-images-amazon.com/images/I/51Bh3EN8zAL.jpg" alt="...">
                                                                    </div>
                                                                    <div class="d-flex flex-column mr-auto">
                                                                        <div class="title">
                                                                            <span class="username">Fátima Rodrigues</span>
                                                                        </div>
                                                                ...
                                                                <div class="comments-body">
                                                                    <p>
                                                                        Seu projeto é muito pertinente para o setor de gestão em grandes corporações. Gostaria de obter mais detalhes, mandei mensagens no privado.
                                                                    </p>
                                                                </div>
                                                                <div class="comments-footer d-flex align-items-center">
                                                                    <div class="meta">
                                                            ...
                                                            <div class="publisher publisher-multi">
                                                                ...
                                                                <div class="publisher-bottom d-flex justify-content-end">
                                                                    <a class="publisher-btn" href="javascript:void(0);"><i class="la la-smile-o"></i></a>
                                                                    <a class="publisher-btn" href="javascript:void(0);"><i class="la la-camera"></i></a>
                                                                    <button class="btn btn-gradient-01">Comentar Portifólio</button>
                                                                </div>
                                                            </div>
                                                            <!-- End Publisher -->
                                                        </div>
                                                    ...
                                                    <div class="col-xl-3 column">
                                                        ...
                                                        <div class="widget has-shadow">
                                                            <div class="new-badge text-center">
                                                                ...
                                                                <div class="title">
                                                                    <div class="heading">Parabéns</div>
                                                                    <div class="text">Você chegou aqui, agora expanda seus contatos no mercado de trabalho.</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- End Badge -->
                                                            ...
                                                            <div class="widget-body">
                                                                <div class="friends-list">
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <a href="javascript:void(0);">
                                                                            <img src="https://is3-ssl.mzstatic.com/image/thumb/Purple115/v4/63/d2/b5/63d2b50a-f423-5fa9-f84e-a73e32c49be0/source/200x200bb.jpg" class="img-fluid rounded-circle" alt="...">
                                                                        </a>
                                                                    </div>
                                                                    <div class="margin-top-20 d-flex justify-content-between">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="https://static.vix.com/es/sites/default/files/styles/thumbnail/public/btg/curiosidades.batanga.com/files/7-excelentes-consejos-para-escribir-tu-curriculum-vitae-05.jpg" class="img-fluid rounded-circle" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                            <img src="https://www.superprof.mx/imagenes/anuncios/profesor-home-preparate-para-siguiente-empleo-curriculum-vitae-plan-carrera-profesional-impacto-queretaro.jpg" class="img-fluid rounded-circle" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                            <img src="http://www.slainte21.com/wp-content/uploads/2013/10/DSC_2525web-e1476052277449.jpg" class="img-fluid rounded-circle" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                            <img src="https://pbs.twimg.com/profile_images/996111544181231616/TUxfBDUk_400x400.jpg" class="img-fluid rounded-circle" alt="...">
                                                                        </a>
                                                                        <a class="view-more" href="javascript:void(0);">
                                                                            +93
                                                                        </a>
