                ...
                <div class="col-md-10 offset-md-1">
                    ...
                    <form method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-3">
                                <label style="margin-left: 3px;" for="pais">Nacionalidade</label>
                                <select name="pais" class="form-control">

                                    <?php foreach ($paises as $pais): ?>
                                        <option value="<?= $pais->paisNome; ?>">
                                            <?= $pais->paisNome; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="num" style="margin-left: 3px; color: #E74C3C">passaporte - (Obritário só para Estrangeiros) </label>
                                <input class="form-control" type="num" value="<?= set_value('passaport'); ?>" name="passaport" placeholder="Só informe se você for estrangeiro..." id="passaport">
                            </div>
