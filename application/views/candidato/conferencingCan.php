    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
                        ...
                        <li>
                            ...
                            <?php while($j <= sizeof($result['carga'])  ): ?>
                                <?php if(!empty($result['carga'][$j]['reuniao'][0]->id_empresa)): ?>
                                   ...
                                   <input  type="hidden" style="margin-left: 60%" class="sala" name="" value="<?php  $sala = $_GET['sala'] ?? "<?= $dados[0]->video_nome; ?>"; echo $sala;  ?>">         
                                                   <?php else: ?>
          ...
          <div class="row" style="margin-top: -110px; margin-left:100px">
           <?php if (empty($_GET['sala'])): ?> 
              <div class="col-md-6" style="margin-top: 10px">
             <img src="https://png.pngtree.com/element_origin_min_pic/16/09/05/1957cd5314e8040.jpg">
             </div>
               <?php else: ?>
                  <div id="localVideo"  style=”float:left;margin-top:0px;margin-bottom:0px;”></div>
               <div id="remoteVideo" style=”float:right;margin-top:-50px;margin-bottom:0px;”></div>
                <?php endif; ?>
          </div>
         </div>
      </div>
...
connection.onstream = function(event) {
    ...
    if(event.type === 'local') {
        video.style = "position: relative; margin-left: -12%; margin-top: 100px; height: 40%; width: 33%; border-radius: 35px;";
    ...
    if(event.type === 'remote') {
      ...
      video.style = "position: relative; margin-left: 24%; margin-top: -500px; height: 40%; width: 33%; border-radius: 35px;";
