...
<link rel="stylesheet" type="text/css" href="<?= base_url(''); ?>assets/styles/news_post_styles.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(''); ?>assets/styles/news_post_responsive.css">
</head>
<body>
	...
	<header class="header d-flex flex-row">
		<div class="header_content d-flex flex-row align-items-center">
			...
			<div class="logo_container">
				<div class="logo">
					<img src="<?= base_url(''); ?>assets/<?= base_url(''); ?>assets/images/logo.png" alt="">
					<span>course</span>
				</div>
			</div>
						...
						<ul class="comments_list">
								...
								<div class="comment_container d-flex flex-row">
									<div>
										<div class="comment_image">
											<img src="<?= base_url(''); ?>assets/images/comment_1.jpg" alt="">
										</div>
									</div>
							...
							<li class="comment">
								<div class="comment_container d-flex flex-row">
									<div>
										<div class="comment_image">
											<img src="<?= base_url(''); ?>assets/images/comment_2.jpg" alt="">
										</div>
									</div>
									<div class="comment_content">
										<div class="comment_meta">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_list">
							  <?php foreach ($alunos as $value): ?>
								<li class="sidebar_list_item"><a href="#">	<?= $value->nome; ?> - <?= $value->nome_curso; ?> </a></li>
								<?php endforeach; ?>
							</ul>
						</div>
...
<script src="<?= base_url(''); ?>assets/js/news_post_custom.js"></script>
