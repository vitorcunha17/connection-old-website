...
<script src="<?= base_url(''); ?>assest/js/contact_custom.js"></script>
</head>
<body>
			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-6 order-2 order-lg-1">
					<div class="become_title">
						<h1>Submit my issue</h1>
					</div>
					<p class="become_text">Enviar um problema na Connection Academy é simples e prático.
						Basta está cadastrado e fazer upload de um vídeo descrevendo o problema em questao. Assim, todas as instituiçoes de ensino
						cadastradas aparesentarao o seu vídeo para os melhores alunos proporem soluçoes.
					</p>
							...
							<div class="elements_accordions">
									<div class="accordion_container">
										...
										<div class="contact_form_container">
											...
											<input name="empresa" id="contact_form_name" class="input_field contact_form_name" type="text" placeholder="Nome da Empresa" required="required" data-error="Infome um nome válido.">
											<input name="email" id="contact_form_email" class="input_field contact_form_email" type="email" placeholder="E-mail" required="required" data-error="Informe um e-mail válido.">
