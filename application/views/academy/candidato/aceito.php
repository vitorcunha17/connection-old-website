            ...
            <div class="row">
              <div class="col-md-4 hidden-sm hidden-xs">
                <aside class="blog-side-bar">
                  ...
                  <video style="  position: relative; z-index:1; margin-left: 1%;margin-top: 1%; height: 61%;" controls  width="350" height="200" >
                            <source src="<?= base_url('assets/candidato/video_editado/'); ?><?= $dados[0]->video_nome; ?>"  type="video/mp4">
                        </video>
                  </div>
                  <!-- Start sidebar widget -->
                  <div class="sidebar-widget">
                    ...
                    <ul class="widget-catg">
                                    ...
                                    <div class="progress">
                                        ...
                                        <span class="progress-title"><p><?= $habilidade_->titulo ?></p></span>
                                        </div>
                                    </div>
                                    <?php } ?>
