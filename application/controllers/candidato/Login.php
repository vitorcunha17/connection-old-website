...
class Login extends CI_Controller {
    ...
    public function logado() {
        ...
        $universidades = $this->logado->listaUniversidades();
        ...
        if($dados[0]->primeiro_acesso == "nao") {
            ...
            $this->load->view('candidato/primeiro_acesso', ['universidades'=> $universidades, 'dados' => $dados, "cursos" => $cursos]);
        }
...
public function cadastraEducacao_() {
 ...
 redirect('candidato/login/aceito/vagas');
            } else {
                $this->session->set_flashdata('msg', '<div stye="background-color: #ffeb3b;" class="alert alert-warning"><div class="container"><div class="col-10 offset-1"><strong>Curriculum já existente.</strong><br> Você já enviou seu curriculum para essa vaga! Aguarde o contato da empresa.</div></div></div>');
 redirect('candidato/login/aceito/vagas');
            }
        }
         ...
         if ($this->input->post('quemsou')) {
            ...
            if ($this->candidato->editaQuemsou($this->input->post('quemsou'), $dados[0]->id_candidato )) {
                ...
                $this->session->set_flashdata('msg', '<div class="alert alert-warning"><div class="container"><div class="col-10 offset-1"><strong>Error</strong><br> Erro! Reinicie a página e tente novamente.</div></div></div>');
                redirect('candidato/login/aceito/');
